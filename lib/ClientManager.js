...
import TimeNow from '../generalFunction'
import { deleteLinkUser } from "../src/controllers/UserController"
...
class ClientManager {
    ...
    removeClient(id) {
        ...
        // this.clients_url =  this.clients_url.filter(client => client.id !== id);
        if (!client) {
            return;
        }
        --this.stats.tunnels;
    ...
    // setClientRegis(info) {
        // this.clients_url.push(info)
    // }
    // getClientRegis() {
        // return this.clients_url
    // }
}
